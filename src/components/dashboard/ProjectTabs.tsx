                  ...
                  <div className="flex flex-col w-full gap-8 lg:gap-4">
                    ...
                    justify-between lg:justify-end w-full">
                      <button
                        ...
                        className="bg-[#E3E6F5] text-[#4343F0] min-w-[120px] px-6 py-2.5 rounded-[8px] lg:rounded-[6px] text-[14px] lg:text-[13px] font-bold relative hover:bg-[#d4d8f0] cursor-pointer"
                      >
                        {p.messages > 0 && (
