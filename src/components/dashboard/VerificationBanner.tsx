...
export default function VerificationBanner() {
  ...
  return (
    <div className="relative z-[60] w-full bg-[#4343F0]/95 backdrop-blur-md border-b border-white/10 px-4 py-2.5 animate-in slide-in-from-top duration-500 shadow-lg">
