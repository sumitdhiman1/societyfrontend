  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        whoCompletedWork: visibleFields.whoCompletedWork ? formData.whoCompletedWork : undefined,
        agreementDetails: visibleFields.agreementDetails ? formData.agreementDetails : undefined,
        scopeOfWork: visibleFields.whatToLookAt ? formData.scopeOfWork : undefined,
        loginsDetails: visibleFields.shareAccess ? (formData.loginsDetails || "checking@societywebsolutions.com") : undefined,
        additionalComments: visibleFields.additionalInfo ? formData.additionalComments : undefined,
    ...
    try {
      const res = await paymentService.createOrder({
        ...
        metadata: {
          ...
          targetWebsiteUrl: formData.targetWebsiteUrl || "https://clientwebsite.com",
          whoCompletedWork: visibleFields.whoCompletedWork ? (formData.whoCompletedWork || "") : "",
          agreementDetails: visibleFields.agreementDetails ? (formData.agreementDetails || "") : "",
          scopeOfWork: visibleFields.whatToLookAt ? (formData.scopeOfWork || "") : "",
          loginsDetails: visibleFields.shareAccess ? (formData.loginsDetails || "checking@societywebsolutions.com") : "",
          additionalComments: visibleFields.additionalInfo ? (formData.additionalComments || "") : "",
