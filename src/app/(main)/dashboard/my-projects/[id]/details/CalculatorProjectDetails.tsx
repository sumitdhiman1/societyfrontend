  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8 w-full font-sans">
      ...
      {activeProject.status === "paused" && (() => {
        const pauseConfig = getPauseReasonConfig(activeProject.pauseReason, activeProject.pauseNote);
        return (
          <div className="bg-amber-50 border border-amber-300 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-amber-700 text-xs mt-0.5">
                {activeProject.pauseNote || pauseConfig.defaultMessage}
              </p>
            </div>
          </div>
        );
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white border border-gray-300 rounded-[12px] shadow-sm p-4 sm:p-6 md:p-8">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-6">
              ...
              >
                {activeProject.status === "paused" ? (getPauseReasonConfig(activeProject.pauseReason, activeProject.pauseNote).badge || "PAUSED") : (activeProject.status || "ACTIVE")}
              </span>
            </div>
              ...
              if (isSystemMsg && !hasFileAttachments && !isQuoteProposal) {
                ...
                if (isDeadlineAdjusted) {
                  ...
                  pauseConfig = getPauseReasonConfig(
                    (msg as any)?.pauseReason || (msg.content as any)?.pauseReason || activeProject?.pauseReason,
                ...
                if (isDeadlineAdjusted || finalTitle === "Deadline Adjusted" || cleanTitle === "Deadline Adjusted") {
                  ...
                  if (!name && (activeProject?.assignedManagers?.[0] as any)?.fullName) {
                    name = (activeProject.assignedManagers[0] as any).fullName;
                  }
                  if (name) {
