    ...
    <div className="w-full font-sans">
      ...
      <div className="mt-5 md:mt-8">
        <div className="flex flex-col gap-6 md:gap-10">
          ...
          <div className="flex flex-col gap-6 w-full">
            ...
            <div className="flex flex-col gap-6 w-full">
              {allMessages.map((msg: any, i: number) => {
                ...
                return (
                  <div key={msgId} ref={isLast ? messagesEndRef : null} className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 md:p-8 shadow-sm">
          ...
          <div ref={messageInputRef} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mt-6 detail-message-box-main">
            {/* Box Top Header */}
            ...
            <div className="px-4 sm:px-6 pb-4 sm:pb-6 pt-2 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-gray-100">
              <input
                ref={fileInputRef}
                type="file"
                multiple
