...
export default function BlogPage() {
  ...
  return (
    <div className="bg-[#041235] min-h-screen flex flex-col font-sans text-gray-600">
      ...
      <div className="bg-[#041235] text-white pt-28 pb-0 shadow-sm">
        <div className="max-w-[1536px] mx-auto px-4 md:px-8 lg:pl-[54px] lg:pr-[62px] flex flex-col items-center">
          ...
          <div className="flex justify-center items-center gap-12 relative">
            <Link
              href="/user-guides"
              className={`text-base sm:text-lg pb-3 transition-all font-medium border-b-2 rounded-none ${pathname === "/user-guides"
            ...
            <Link
              href="/blog"
              className={`text-base sm:text-lg pb-3 transition-all font-medium border-b-2 rounded-none ${pathname === "/blog"
                ? "text-white border-[#5b63d3]"
                : "text-gray-400 hover:text-gray-200 border-transparent"
                }`}
            >
      ...
      <main className="bg-[#041235] flex-grow w-full maxgrid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16-w-[1600px] mx-auto pt-16 pb-20">
        {isLoading ? (
